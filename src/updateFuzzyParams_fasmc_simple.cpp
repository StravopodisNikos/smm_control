...
void setupFuzzyEngine() {
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        alpha[i]->addTerm(new fl::Gaussian("AO1", 0.1, 0.05));    // 0.001, 0.0005
        alpha[i]->addTerm(new fl::Gaussian("AO2", 0.5, 0.05));    // 0.01, 0.005
        alpha[i]->addTerm(new fl::Gaussian("AO3", 0.9, 0.05));    // 0.1, 0.05
        ...
        beta[i]->addTerm(new fl::Gaussian("BO1", 0.1, 0.05));   // 0.001, 0.0005
        beta[i]->addTerm(new fl::Gaussian("BO2", 0.5, 0.05));   // 0.01, 0.005
        beta[i]->addTerm(new fl::Gaussian("BO3", 0.9, 0.05));   // 0.1, 0.05
        ...
        gammaParams[i]->setRange(1.0, 10.0);
        gammaParams[i]->addTerm(new fl::Gaussian("GO1", 1.50, 0.1));  // 0.1, 0.05
        gammaParams[i]->addTerm(new fl::Gaussian("GO2", 5.00, 0.25)); // 0.25, 0.15
        gammaParams[i]->addTerm(new fl::Gaussian("GO3", 9.00, 0.25)); // 0.50, 0.25
