...
int main(int argc, char** argv) {
    ros::init(argc, argv, "updateErrorState_ridosc_simple");
    ros::NodeHandle nh;

    // Subscriber for the desired TCP state
    ros::Subscriber desired_state_sub = nh.subscribe("/ridosc_desired_state", 10, desiredStateCallback);
    ...
    ros::Publisher error_state_pub = nh.advertise<smm_control::IdoscError>("/ridosc_error_state", 10);
