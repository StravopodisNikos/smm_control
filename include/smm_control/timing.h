...
constexpr double UPDATE_ERROR_STATE_RATE        = 5.0;
...
constexpr double UPDATE_JOINT_PATH_LOOP_RATE 		= 0.5;           
constexpr double UPDATE_SERVER_DYNAMICS_RATE 		= 5.0; 
constexpr double UPDATE_JOINT_STATE_RATE 				= 5.0;
