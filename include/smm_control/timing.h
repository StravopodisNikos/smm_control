...
constexpr double UPDATE_ROBUST_TORQUE_RATE 			= 10.0;    // 1000
constexpr double UPDATE_TORQUE_COMMAND_RATE 		= 10.0;     // 100
...
constexpr double UPDATE_JOINT_STATE_RATE 		    = 10.0;    // 1000
